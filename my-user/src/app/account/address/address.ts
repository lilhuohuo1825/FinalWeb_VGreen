...
export class AddressComponent implements OnInit, OnDestroy {
 ...
 // Convert ServiceAddressInfo to Address format for display
      const mappedAddresses = addresses.map((addr) => ({
        ...
        district: this.addressService.getDistrictNameFromId(addr.district),
        ward: this.addressService.getWardNameFromId(addr.ward),
 ...
 // Map Address to AddressInfo
    this.addressInfoForForm = {
      ...
      phone: address.phone,
      email: address.email,
      city: this.addressService.getCityIdFromName(address.province),
      district: this.addressService.getDistrictIdFromName(address.district),
      ward: this.addressService.getWardIdFromName(address.ward),
