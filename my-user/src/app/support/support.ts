  ...
  faqItems: FAQItem[] = [
    {
      ...
      answer:
        'Có thể! Bạn có thể hủy đơn hàng trong vòng <strong>30 phút</strong> sau khi đặt hàng thành công. Sau thời gian này, đơn hàng đã được xử lý và không thể hủy.',
      isExpanded: false,
    },
    {
      id: 2,
  ...
  supportItems: SupportItem[] = [
    {
      id: 1,
      icon: 'faq',
      iconPath: '/assets/icons/info_dark.png',
      title: 'Câu hỏi thường gặp',
      content: `
        <div class="faq-list">
          <div class="faq-item">
            <h4>Tôi có thể hủy đơn hàng sau khi đặt không?</h4>
            <p>Có thể! Bạn có thể hủy đơn hàng trong vòng <strong>30 phút</strong> sau khi đặt hàng thành công. Sau thời gian này, đơn hàng đã được xử lý và không thể hủy.</p>
          </div>
          ...
          <div class="faq-item">
            ...
            <ol>
              ...
              <li>Gọi hotline <strong>0123 456 789</strong> hoặc gửi email <strong>vgreen@gmail.com</strong></li>
    ...
    },
    {
      id: 2,
      icon: 'guide',
      iconPath: '/assets/icons/history_dark.png',
    ...
    },
    {
      id: 3,
      icon: 'return',
      iconPath: '/assets/icons/return_dark.png',
      ...
      content: `
        ...
        <ol>
          ...
          <li><strong>Liên hệ hỗ trợ:</strong> Gọi hotline <strong>0123 456 789</strong> hoặc email <strong>vgreen@gmail.com</strong></li>
