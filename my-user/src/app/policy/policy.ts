  ...
  policies: PolicyItem[] = [
    {
      ...
      content: `
        ...
        <ol>
          ...
          <li>Liên hệ hotline <strong>0123 456 789</strong> hoặc email <strong>vgreen@gmail.com</strong></li>
    ...
    },
    {
      id: 2,
      icon: 'shop',
      iconPath: '/assets/icons/shop_dark.png',
    ...
    },
    {
      id: 3,
      icon: 'protect',
      iconPath: '/assets/icons/protect_dark.png',
    ...
    },
    {
      id: 4,
      icon: 'logistic',
      iconPath: '/assets/icons/logistic_dark.png',
    ...
    },
    {
      id: 5,
      icon: 'setting',
      iconPath: '/assets/icons/setting_dark.png',
      ...
      content: `
        ...
        <ol>
          ...
          <li>Liên hệ ngay hotline <strong>0123 456 789</strong> hoặc email <strong>vgreen@gmail.com</strong> trong vòng <strong>24 giờ</strong></li>
